              ...
              <table class="table table-striped" id="table-1">
                ...
                <tbody>
                  <?php
                    ...
                    echo "</pre>";*/
                  ?>
                  <?php $i=1; foreach ($dataalat as $key) { ?>
                      <tr>
                          ...
                          <td class="text-center" >
                            <?php
                              if ($key->sts_pjm==1) { ?>
                            <a href="<?php $data=$this->encryption->encrypt(base64_encode($key->id_pjm)); $ff=str_replace(array('+','/','='),array('-','_','~'),$data); echo base_url();?>pinjam/cetak_pinjam_alat/<?php echo $ff; ?>" target="_blank">
                            ...
                            <!-- <button type="button" class="btn btn-success btn-sm" data-toggle="tooltip" title="Upload Dokumen Untuk TTE">
                             ...
                             <a href="<?php   
                                $data=$this->encryption->encrypt(base64_encode($key->id_pjm)); $ff=str_replace(array('+','/','='),array('-','_','~'),$data); echo base_url();?>pinjam/edit_pinjaman_alat/<?php echo $ff; ?>">
                            ...
                            <button type="button" class="btn btn-danger btn-sm" data-toggle="tooltip" title="Hapus Nomor" id="hapus" data-nopin="<?php echo $key->nopinjam;?>" data-id="<?php echo $key->id_pjm;?>" data-nmbarang="<?php echo $key->nmbarang;?>">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer bg-whitesmoke br">
         <?php echo form_open_multipart('pinjam/hapus_pinjam_alat');?>
...
<div class="modal fade" id="modal_status" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <?php echo form_open_multipart('pinjam/ubah_status_pinjam_alat');?>
      <div class="modal-body">
...
$(document).on('click','#hapus',function(){
        ...
        var id=$(this).data('id');
        var hal=$(this).data('nmbarang');
        var text="Hapus Nomor Peminjaman : "+no;
        var tgh= "Nama Alat : "+hal;
        $("#mp-tex").text(text);
        $("#mp-tex1").text(tgh);
        $("#id_del").val(no);
});
