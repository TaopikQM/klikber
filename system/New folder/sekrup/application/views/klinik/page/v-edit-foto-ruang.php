        ...
        <div class="card">
          ...
          <div class="card-body">
             <?php
              ...
              echo form_open_multipart('ruangan/ruang_up_foto',$arrayName);
            ?>
             <div class="form-row" >
               <div class="form-group col-md-12">
                <label>Tambah Foto Ruangan</label>
            ...
            <div class="card-footer text-center">
              ...
              <input type="hidden" name="narung" value="<?php echo $nopola;?>">
            ...
            <?php
              ...
              $arrayName = array('class'=>"needs-validation",'novalidate'=>'');
              echo form_open_multipart('ruangan/ruang_del_foto',$arrayName);
            ?>
