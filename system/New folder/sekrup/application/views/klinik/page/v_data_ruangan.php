      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <a href="<?php echo base_url()?>ruangan/tambah">
            <button type="button" class="btn btn-info btn-icon icon-left">
                  <i class="fas fa-plus"></i> Tambah
            </button></a>
            <h4>&nbsp|| Data Nomor  </h4>
            <a href="<?php echo site_url('reports/ruang_ekspor_excel/exruang') ?>" class="btn btn-success" target="_blank">
              ...
              <table class="table table-striped table-hover" id="table-1" style="width:100%;" >
                ...
                <tbody>
                  <?php
                    ...
                    echo "</pre>";*/
                  ?>
                  <?php $nomori=1; foreach ($dataruang as $key) { ?>
                      <tr bgcolor="#cccccc">
                          ...
                          <td  class="text-center">
                            <?php 
                              ...
                              if (isset($handle[0]) && $handle !=NULL) {
                                ...
                                echo '<img class="d-block w-100" width="100" height="120" src="'.base_url().$handle[0].'" alt="'.$key->nmruang.'"></a>';
                              }
                            ?>
                          </td>
                          <td class="text-center" >
                          ...
                          <td  class="text-center">
                             <span class="badge badge-primary"><?php echo $key->kapasi;?> Orang</span>
                          </td>
                          ...
                          <td class="text-center" >
                            <?php
                              if (file_exists(FCPATH."harta/pinjam/dataruang/".$key->nmfile.".pdf")) {
                                  $wpy="";?>
                            <a href="<?php echo base_url()?>harta/pinjam/dataruang/<?php echo $key->nmfile;?>.pdf">
                            ...
                            <a href="<?php $dxc=$this->encryption->encrypt(base64_encode($key->id)); $ff=str_replace(array('+','/','='),array('-','_','~'),$dxc); echo base_url();?>ruangan/foto/<?php echo $ff; ?>">
                            <button type="button" class="btn btn-dark btn-sm" data-toggle="tooltip" title="Edit Foto">
                              <i  class="fa fa-camera" aria-hidden="true"></i>
                            </button></a>

                            <a href="<?php $dxc=$this->encryption->encrypt(base64_encode($key->id)); $ff=str_replace(array('+','/','='),array('-','_','~'),$dxc); echo base_url();?>ruangan/edit/<?php echo $ff; ?>">
                            ...
                            <button type="button" class="btn btn-danger btn-sm" data-toggle="tooltip" title="Hapus Nomor" id="hapus" data-nmfile="<?php echo $key->nmfile;?>" data-nmruang="<?php echo $key->nmruang;?>" data-id="<?php echo $key->id;?>" >
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer bg-whitesmoke br">
         <?php echo form_open_multipart('ruangan/hapus');?>
            <input type="hidden" name="id" value="" id="id_del">
            <input type="hidden" name="narungmod" value="" id="narungmod">
