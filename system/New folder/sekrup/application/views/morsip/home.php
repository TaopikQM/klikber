...
<body>
  ...
  <div id="app">
    <div class="main-wrapper main-wrapper-1">
      ...
      <?php $this->load->view('morsip/section/menu_atas')?>
      <?php $this->load->view('morsip/section/menu_samping')?>
  ...
  <!-- Custom JS File -->
  <script src="<?php echo base_url()?>harta/morsip/assets/js/custom.js"></script>
