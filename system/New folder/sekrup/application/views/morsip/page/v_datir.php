          ...
          <div class="card-header">
            ...
            <!-- <ul class="pagination"> -->
              <?php
                ...
                $fg=$jumdat/1000;$i=1;
                while ($i <=ceil($fg)) {?>
                  <div class="page-item"><a class="page-link" href="<?php echo base_url();?>morsip/datadatir/<?php echo$i;?>"><?php echo"$i";?></a></div>
                <?php $i++; }
              ?><!-- </ul> -->
          </div>
          <div class="card-body">
                  ...
                  <?php $i=1; foreach ($datasur as $key) { ?>
                      <tr>
                          ...
                          <td  class="text-center">
                            ...
                            $daa=$this->encryption->encrypt(base64_encode(str_replace(".","-",$key->nosur))); 
                          ...
                          <td>
                            ...
                            <?php }
                               ?>
                                <a href="<?php   
                                $data=$this->encryption->encrypt(base64_encode($key->id)); $ff=str_replace(array('+','/','='),array('-','_','~'),$data); echo base_url();?>morsip/edit_nomor_datir/<?php echo $ff; ?>">
                              ...
                              <?php 
                                ...
                                if (!file_exists(FCPATH."harta/morsip/doc/dokumen$tahun/$key->nmf.pdf") && $key->k!=212){ ?>
                                    <a href="<?php $data=$this->encryption->encrypt(base64_encode($key->id)); $ff=str_replace(array('+','/','='),array('-','_','~'),$data); echo base_url();?>morsip/up_doc_datir/<?php echo $ff; ?>">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer bg-whitesmoke br">
         <?php echo form_open_multipart('morsip/hapus_nomor_datir');?>
