          ...
          <div class="card-body">
            ...
            <?php $arrayName = array(
                  'class'=>"needs-validation",
                       'novalidate'=>'');
            echo form_open_multipart('morsip/save_perlu',$arrayName);?>
            <div class="form-group">
              <div class="form-group col-md-12">
                  <?php
                      ...
                      $tgloi= date("Y-m-d");
                  ?>
                  <label for="user">Dasar Keperluan</label>
                  <textarea name="nama" id="nama" required="required" class="form-control" placeholder="Input Dasar Surat"><?php echo set_value('nama'); ?></textarea>
                   <?php  echo form_error('nama'); ?>
                  <div class="invalid-feedback">
                        Silahkan Input Dasar Keperluan
                  </div>
              </div>
            </div>
