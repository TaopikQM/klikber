...
<?php
foreach ($jabatan as $keya) {
  $nama=$keya->nama_jabatan;
  $id=$keya->id;
}
          ...
          <div class="card-body">
            ...
            <?php $arrayName = array(
                  'class'=>"needs-validation",
                       'novalidate'=>'');
            echo form_open_multipart('morsip/save_e_jabatan',$arrayName);?>
            <div class="form-group">
              <div class="form-group col-md-12">
                  ...
                  <input type="text" class="form-control" name="nama" id="nama" required="required"  value="<?php echo $nama; ?>" placeholder="Input Nama Jabatan">
