          ...
          <div class="card-body">
            ...
            $arrayName = array(
                  'class'=>"needs-validation",
                       'novalidate'=>'');
            echo form_open_multipart('morsip/save_e_nomor',$arrayName);?>
             <div class="form-row">
              <div class="form-group col-md-3">
                  <?php
                      ...
                      if ($isu==1 && ($vyj[1] != 0)) {
                        $bdx='disabled="disabled"';
                      }else{
                        $bdx='';
                      }
                  ?>
                  <label for="tgl">Tanggal Surat <?php echo $tgl;?></label>
                  <input type="date" class="form-control" min="<?php echo $tgloi;?>"  name="tgl" id="tgl" required="required" value="<?php echo $tgl?>" <?php echo $bdx;?> >
            ...
            <div class="card-footer text-center">
              ...
              <input type="hidden" name="isu" value="<?php echo $isu;?>">
              <input type="hidden" name="nosur" value="<?php echo $nosur;?>">
              <input type="hidden" name="link" value="<?php echo $link;?>">
              <input type="hidden" name="a" value="<?php echo $aa;?>">
