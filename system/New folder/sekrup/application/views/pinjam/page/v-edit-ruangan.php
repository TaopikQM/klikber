          ...
          <div class="card-body">
            ...
            $arrayName = array(
                  'class'=>"needs-validation",
                       'novalidate'=>'');
            echo form_open_multipart('ruangan/simpan_edit',$arrayName);?>
             <div class="form-row">
              <div class="form-group col-md-3">
                  <label for="tgl">Nama Ruangan <?php  echo form_error('narung'); ?></label>
                  <input type="hidden" name="narungold" value="<?php echo $nmruang;?>">
                  <input type="text" class="form-control" name="narung" id="narung" value="<?php echo $nmruang;?>" required="required">
                   <?php  echo form_error('narung'); ?>
              ...
              <div class="form-group col-md-3">
                  ...
                  <select name="lantai" class="form-control" id="lantai">
                      ...
                      <?php
                        for ($i=1; $i <5; $i++) { ?>
                          <option <?php if ($ltruang == $i) {
                            echo "selected='selected'";
                          }?> value="<?php echo sprintf("%02d", $i)?>">Lantai <?php echo sprintf("%02d", $i);?></option>                     
                      <?php
                        }
                      ?>                     
                  </select>
            ...
            <div class="form-row">
              <div class="form-group col-md-3">
                  ...
                  <input type="number" class="form-control" name="kapsi" id="kapsi" value="<?php echo $kapasi;?>" required="required">
           ...
           <div class="form-group">
             ...
             <!--  <iframe src="<?php //echo base_url()?>harta/pinjam/dataruang/<?php // echo $nmfile;?>.pdf" width="600" height="400"></iframe>-->
              <embed src="<?php echo base_url()?>harta/pinjam/dataruang/<?php echo $nmfile;?>.pdf?<?php echo time();?>" width="700px" height="600px" /> 
              </div>
            </div>
