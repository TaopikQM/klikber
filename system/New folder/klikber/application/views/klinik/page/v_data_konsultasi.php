      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            ...
            <h4>&nbsp|| Data Konsultasi Dokter  </h4>
            </br>
              ...
              <table class="table table-striped table-hover" id="table-1" style="width:100%;" >
                <thead>
                  <tr bgcolor="#cccccc" >
                    ...
                    <th class="text-center">PERTANYAA</th>
                ...
                <tbody>
                  <?php
                    ...
                    // echo "</pre>";
                  ?>
                  <?php if (isset($pasiens) && !empty($pasiens)): ?> 
                    <?php $nomori=1; foreach ($pasiens as $key) { ?>
                        <tr bgcolor="#cccccc">
                            ...
                            <td class="text-center" >
                              ...
                              <a href="<?php $dxc=$this->encryption->encrypt(base64_encode($key['id_konsul'])); $ff=str_replace(array('+','/','='),array('-','_','~'),$dxc); echo base_url();?>pasien/ekonsul/<?php echo $ff; ?>">
                              <button type="button" class="btn btn-warning btn-sm" data-toggle="tooltip" title="EditK">
