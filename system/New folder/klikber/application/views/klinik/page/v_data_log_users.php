              ...
              <table class="table table-striped table-hover" id="table-1" style="width:100%;" >
                <thead>
                  <tr bgcolor="#cccccc" >
                    ...
                    <th class="text-center">T.LOGOUT</th>
                  ...
                  <?php if (isset($users) && !empty($users)): ?>
                    <?php $nomori=1; foreach ($users as $key) { ?>
                        <tr bgcolor="#cccccc">
                            ...
                            <td class="text-center" >
                              <?php 
                                echo $key->logout_time; ?> 
                            </td>    
                            
                            <td class="text-center" >

                              <!-- <a href="<?php $dxc=$this->encryption->encrypt(base64_encode($key->id)); $ff=str_replace(array('+','/','='),array('-','_','~'),$dxc); echo base_url();?>users/edit/<?php echo $ff; ?>">
                              <button type="button" class="btn btn-warning btn-sm" data-toggle="tooltip" title="Edit Users">
                              ...
                              <button type="button" class="btn btn-danger btn-sm" data-toggle="tooltip" title="Hapus Nomor" id="hapus" data-id="<?php echo $key->id;?>" data-username="<?php echo $key->username;?>">
