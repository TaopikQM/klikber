      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            ...
            <h4>&nbsp|| Data Riwayat Periksa  </h4>
            </br>
                  ...
                  <?php if (isset($periksa) && !empty($periksa)): ?>
                    <?php $nomori=1; foreach ($periksa as $key) { ?>
                        <tr bgcolor="#cccccc">
                            ...
                            <!-- <?php echo $key->id_periksa; ?> -->
                              <a href="<?php $dxc=$this->encryption->encrypt(base64_encode($key->id_periksa)); $ff=str_replace(array('+','/','='),array('-','_','~'),$dxc); echo base_url();?>dokter/edit_riwayat/<?php echo $ff; ?>">
