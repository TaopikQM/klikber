              ...
              <table class="table table-striped table-hover" id="table-1" style="width:100%;" >
                ...
                <tbody>
                  <?php
                    ...
                    echo "</pre>";*/
                  ?>
                  <?php if (isset($obats) && !empty($obats)): ?>
                    <?php $nomori=1; foreach ($obats as $key) { ?>
                        <tr bgcolor="#cccccc">
                            <td  class="text-center"><?php echo $nomori;?></td>
                            
                            <td class="text-center" >
                              <?php 
                                echo $key->nama_obat."<br>";
                              ?>    
                            </td> 
                            
                            <td class="text-center">
                              <?php 
                              // Array untuk memetakan nilai kemasan ke nama kemasan
                              $kemasan_map = [
                                  '0' => 'Tablet',
                                  '1' => 'Botol'
                              ];
                              
                              // Ambil nama kemasan berdasarkan nilai
                              $nama_kemasan = isset($kemasan_map[$key->kemasan]) ? $kemasan_map[$key->kemasan] : 'Tidak Diketahui';
                              echo $nama_kemasan; 
                              ?>
                          </td>
                          <td class="text-center"><?php echo $key->harga;?></td>
                            <td class="text-center" >
                              ...
                              <a href="<?php $dxc=$this->encryption->encrypt(base64_encode($key->id)); $ff=str_replace(array('+','/','='),array('-','_','~'),$dxc); echo base_url();?>obat/edit/<?php echo $ff; ?>">
                              ...
                              <button type="button" class="btn btn-danger btn-sm" data-toggle="tooltip" title="Hapus " id="hapus"  data-id="<?php echo $key->id;?>" data-nama_obat="<?php echo $key->nama_obat; ?>">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer bg-whitesmoke br">
         <?php echo form_open_multipart('klinik/Obat/delete');?>
