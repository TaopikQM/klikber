...
function Header()
{
    ...
    // Move to the right
    $this->SetXY(10,7);
    $this->Cell(190,5,'e-FORMULIR PEMINJAMAN ALAT KANTOR',0,2,'C');
/*    $this->SetX(40);
...
$pdf->SetX(10);
$pdf->Cell(190,6,'Dengan ini memberikan peminjaman Alat dengan rincian sebagai berikut :',0,1,'L');
...
$pdf->Cell(42,5,'Waktu',0,0,'C');
$pdf->Cell(5,5,':',0,0,'L');
$pdf->Cell(60,5,$time,0,1,'L');
