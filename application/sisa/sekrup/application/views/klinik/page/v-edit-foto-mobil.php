      ...
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 col-12">
        <div class="card">
          <div class="card-header">
            ...
            <h4>Edit Foto Mobil <h2><?php echo $nopola?></h2></h4>&nbsp&nbsp
            <a href="<?php echo base_url()?>mobil"> 
            <button type="button" class="btn btn-info btn-icon icon-left">
                  <i class="fas fa-angle-left"></i>Data Mobil
            </button></a>
          </div>
          <div class="card-body">
             <?php
              ...
              echo form_open_multipart('mobil/mobil_up_foto',$arrayName);
            ?>
             <div class="form-row" >
            ...
            <div class="card-footer text-center">
              ...
              <input type="hidden" name="nopol" value="<?php echo $key->nopol;?>">
              <input type="hidden" name="tipe" value="mobil">
            ...
            <?php
              ...
              $arrayName = array('class'=>"needs-validation",'novalidate'=>'');
              echo form_open_multipart('mobil/mobil_del_foto',$arrayName);
            ?>

            <div id="aniimated-thumbnials" class="list-unstyled row clearfix">
              <?php 
                $hbg=str_replace(" ","",$nopola);
                $folder = "harta/pinjam/datamobil/".strtoupper($hbg);
                $handle =  glob($folder."/*.*");
                if ($handle) {
