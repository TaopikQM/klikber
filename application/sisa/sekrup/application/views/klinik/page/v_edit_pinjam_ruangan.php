          ...
          <div class="card-body">
            ...
            <?php $arrayName = array(
                  'class'=>"needs-validation",
                       'novalidate'=>'');
            echo form_open_multipart('pinjam/save_e_pinjam_ruang',$arrayName);?>
             <div class="form-row">
            ...
            <div class="form-group col-md-12">
                ...
                <select name="jns" class="form-control select2 inputan" id="jns" required="required" disabled="disabled" >                    
                      ...
                      <option value="a2" <?php if ($jnspinjam=="a2") { echo "selected=selected"; } ?> >Ruangan</option>                                       
                </select>
            ...
            <div class="form-group col-md-12">
                  ...
                  <label class="imagecheck mb-4">
                    ...
                    <span class="imagecheck-figure">
                      <div id="carouselExampleIndicators0" class="carousel slide" data-ride="carousel">  
                       <?php 
                          $bdh=str_replace(" ","",$nmruangx);
                          $fold = "harta/pinjam/dataruang/".strtoupper($bdh);
                          $getdc =  glob($fold."/*.*"); ?>          
                                <div class="carousel-inner"><?php
                                  for ($iw=0; $iw < count($getdc) ; $iw++) { 
                                    ...
                                    <div class="carousel-item <?php echo $ftp;?>">
                                      <img class="d-block w-100" src="<?php echo base_url().$getdc[$iw];?>" alt="<?php echo $nmruangx;?>" witdh="100" height="200">
                                          <div class="carousel-caption d-none d-md-block">
                                            <span class="badge badge-primary"><?php echo $nmruangx; ?></span>
                                  </div>
                                    </div>;
                                  <?php }?>
                                </div>
                ...
                <?php $aw=1; 
                  foreach ($lisruang as $keya){
                  $hbg=str_replace(" ","",$keya->nmruang);
                                    ...
                                    <div class="carousel-inner"><?php
                                      for ($ib=0; $ib < count($handle) ; $ib++) { 
                                        ...
                                        <div class="carousel-item <?php echo $drw;?>">
                                          <img class="d-block w-100" src="<?php echo base_url().$handle[$ib];?>" alt="<?php echo $keya->nmruang;?>" witdh="100" height="200">
                                              <div class="carousel-caption d-none d-md-block">
                                                <span class="badge badge-primary"><?php echo $keya->nmruang; ?></span>
                                      </div>
                                        </div>;
                                      <?php }?>
                                    </div>
