              ...
              <table class="table table-striped table-hover" id="table-1" style="width:100%;" >
                ...
                <tbody>
                  ...
                  <?php if (isset($admins) && !empty($admins)): ?>
                    <?php $nomori=1; foreach ($admins as $key) { ?>
                        <tr bgcolor="#cccccc">
                            ...
                            <td class="text-center" >
                              ...
                              <a href="<?php $dxc=$this->encryption->encrypt(base64_encode($key->id)); $ff=str_replace(array('+','/','='),array('-','_','~'),$dxc); echo base_url();?>admin/edit/<?php echo $ff; ?>">
                              ...
                              <button type="button" class="btn btn-danger btn-sm" data-toggle="tooltip" title="Hapus Nomor" id="hapus" data-id="<?php echo $key->id;?>" data-nama="<?php echo $key->nama;?>">
