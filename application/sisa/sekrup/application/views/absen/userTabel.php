    ...
    <script>  
        ...
        const handleAttendance = async (userName, userStatus) => {
            ...
            try {
                ...
                //ini bagian filter lokasi jika sesuai maka data disimpan jika tidak maka tidak disimapn 
                ...
                if (latitude && longitude) {
                    ...
                    if (distanceToKominfo > 0.1) {
                        ...
                        //ini kodingan awal tidak diubah
        ...
        //                 const {kegiatan, timeot}= attendanceExist;
        //                 let id = attendanceExist.id; // Ubah dari const ke let

        //                 if (attendanceExist.kegiatan === "" && attendanceExist.timeot === "00:00:00" ){
        //                     const kegiatan = prompt('Masukkan kegiatan Anda sebelum pulang:');
        //                     if (!kegiatan) {
        //                         alert('Anda harus memasukkan kegiatan.');
        //                         loading = false;
        //                         document.getElementById('PulangButton').innerText = 'Pulang'; // Kembalikan teks tombol
        //                         return;
        //                     }
        ...
        //                         alert(`Absensi pulang berhasil untuk hari ini.\n ${userName}\nKegiatan: ${kegiatan}\nSelamat istirahat!`);
        //                         loading = false;
        //                         document.getElementById('PulangButton').innerText = 'Pulang'; // Kembalikan teks tombol
        //                         }
        //                     }
            ...
            try {
                ...
                //ini bagian filter lokasi jika sesuai maka data disimpan jika tidak maka tidak disimapn 
                    if (latitude && longitude) {
                        ...
                        //ini kodingan awal tidak ada perubahan
                        else{
                            if (userStatus !== 'Active') {
                                alert('Pengguna tidak ditemukan di sistem. Silakan hubungi admin.');
                                return;
                            ...
                            // Cek apakah ada kehadiran untuk pengguna pada tanggal yang ditentukan
                            const attendanceCheckResponse = await fetch('AttendanceController/checkAttendanceP', {
                                method: 'POST',
                                headers: {
                                    'Content-Type': 'application/json'
