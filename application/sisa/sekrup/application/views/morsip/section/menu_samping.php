<div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="<?php echo base_url('morsip')?>"> <img alt="image" src="<?php echo base_url()?>harta/morsip/assets/img/logo.png" class="header-logo" /> <span
                class="logo-name">Morsip</span>
            </a>
          </div>
          <ul class="sidebar-menu">
            ...
            <li class="dropdown">
              <a href="#" class="menu-toggle nav-link has-dropdown"><i
                  data-feather="mail"></i><span>Nomor Antidatir</span></a>
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="<?php echo base_url('morsip/datadatir')?>">Data Antidatir</a></li>
                <li><a class="nav-link" href="<?php echo base_url('morsip/input_datir')?>">Input Antidatir</a></li>
              </ul>
            </li>

            <li class="dropdown">
              <a href="#" class="menu-toggle nav-link has-dropdown"><i
                  data-feather="sliders"></i><span>Admin</span></a>
              <ul class="dropdown-menu">
                <li><a href="<?php echo base_url('morsip/daftar_admin')?>">Daftar Admin</a></li>
                <li><a href="<?php echo base_url('morsip/input_admin')?>">Input Admin</a></li>
              </ul>
            </li>
           <?php }
           ?>
