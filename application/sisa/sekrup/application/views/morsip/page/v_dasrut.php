          ...
          <div class="card-header">
            ...
            <!-- <ul class="pagination"> -->
              <?php
                ...
                <?php $i++; }
              ?><!-- </ul> -->
               <a href="<?php echo base_url();?>morsip/input_dasrut">
                ...
                <tbody>
                  ...
                  $tg="NON AKTIF";
                        ...
                        <td>
                        	<?php
	                      		if ($key->sts == 1) { ?>
									<button type="button" class="btn btn-danger btn-md" data-toggle="tooltip" title="Non Aktifkan Dasar Surat" id="hapus" data-nama="<?php echo $key->isi;?>" data-id="<?php echo $key->id;?>" data-status="<?php echo $key->sts;?>">
                              			<i  class="fa fa-trash" aria-hidden="true"></i>
                              		</button>                          			
	                      	<?php
	                      		}else{ ?>
	                      			<button type="button" class="btn btn-info btn-md" data-toggle="tooltip" title="Aktifkan Pegawai Dasar Surat" id="hapus" data-nama="<?php echo $key->isi;?>" data-id="<?php echo $key->id;?>" data-status="<?php echo $key->sts;?>">
                              			<i  class="fa fa-heart" aria-hidden="true"></i>
                              		</button>
	                      	<?php
	                      		} ?>
	                      		<a href="<?php   
                                $data=$this->encryption->encrypt(base64_encode($key->id)); $ff=str_replace(array('+','/','='),array('-','_','~'),$data); echo base_url();?>morsip/edit_dasrut/<?php echo $ff; ?>">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer bg-whitesmoke br">
         <?php echo form_open_multipart('morsip/hapus_dasrut');?>
