        ...
        <div class="card">
          ...
          <div class="card-body">
            <?php
              //echo "<pre>"; 
              //print_r($data);
              //print_r($this->session->userdata(base64_encode('jajahan')));
              $dc=$this->session->userdata(base64_encode('jajahan'));
              $vyj=null;
              for ($i=0; $i < count($dc) ; $i++) {
                if (base64_decode($dc[$i][base64_encode('apli')])=='1_morsip'){
                  $vyj=explode("_",$this->encryption->decrypt($dc[$i][base64_encode('hk')]));
            ...
            $arrayName = array(
                  'class'=>"needs-validation",
                       'novalidate'=>'');
            echo form_open_multipart('morsip/save_e_nomor_datir',$arrayName);?>
             <div class="form-row">
              <div class="form-group col-md-3">
                  ...
                  ?>
                  <label for="tgl">Tanggal Surat <?php echo $tgl;?></label>
                  <input type="date" class="form-control" min="<?php echo $tgloi;?>"  name="tgl" id="tgl" required="required" value="<?php echo $tgl?>" disabled="disabled">
                ...
                <select name="kodesur" class="form-control select2" required="required">
                  ...
                  <?php 
                    foreach ($kodesur as $kya) {?>
                        ...
                        ?>
                        value="<?php echo $kya->id;?>" ><?php echo $kya->kode." - ".$kya->isi ?></option>
              ...
              <div class="form-group col-md-6">
                <label>Bidang / Sie </label>
                <select name="idbid" class="form-control select2" required="required">
                      <option value="">Plih Bidang / Sie</option>
                  <?php 
                    foreach ($bidang as $bb) {?>
                        <option 
                        <?php 
                        if ($b==$bb->id) {
                          echo "selected='selected'";
                        ...
                        ?>
                        value="<?php echo $bb->id;?>" ><?php echo  $bb->n_bid; ?></option>
            ...
            <div class="form-group">
              <label>Perihal</label>
              <textarea class="form-control summernote-simple" required="required" name="perihal" value=""><?php echo $perihal;?></textarea>
              <div class="invalid-feedback">
             ...
             <div class="form-group">
              <label>Kepada</label>
              <input type="text" name="kpd" placeholder="Kepada" class="form-control" required="required" value="<?php echo $kpd?>">
              <div class="invalid-feedback">
                    Silahkan Input Tujuan Surat
              </div>
            </div>
            <div class="form-group">
              <label>File (Silahkan Isi Jika Ingin Mengganti Dokumen)</label>
              <input type="file" class="form-control"  name="pile" id="pile" accept="application/pdf">
              <div class="invalid-feedback">
            ...
            <label>Review File</label>
              <embed width="100%" height="800" src="<?php echo base_url()?>harta/morsip/doc/dokumen<?php echo $tahun."/".$link.".pdf";?>"></embed>
            ...
            <div class="card-footer text-center">
              ...
              <input type="hidden" name="idad" value="<?php echo $idad;?>">
              <input type="hidden" name="nosur" value="<?php echo $nosur;?>">
