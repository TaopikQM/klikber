          ...
          <div class="card-body">
            ...
            <?php $arrayName = array(
                  'class'=>"needs-validation",
                       'novalidate'=>'');
            echo form_open_multipart('morsip/save_nomor_datir',$arrayName);?>
             <div class="form-row">
              <div class="form-group col-md-3">
                  ...
                  <input type="date" class="form-control" min="" value="<?php echo set_value('tgl'); ?>" name="tgl" id="tgl" required="required">
            ...
            <div class="form-row">
              <div class="form-group col-md-6">
                <label>Pilih Nomor Antidatir</label>
                <select name="nodatir" id="nodatir" class="form-control select2" required="required">
                      <!-- <option value="">Plih Nomor Surat</option> -->
                </select>
                 <?php  echo form_error('kodesur'); ?>
                <div class="invalid-feedback">
                        Silahkan Pilih Kode Surat
            ...
            <div class="form-group col-md-3">
                  <label for="tambahan">Nomor Tambahan</label>
                  <div id="tambah"></div>
                   <?php  echo form_error('tambahan'); ?>
                  <div class="invalid-feedback">

                        Ini nomor tambahan antidatir
                  </div>
            </div>
            ...
            <div class="form-group">
              <label>Perihal</label>
              <textarea class="form-control summernote-simple" required="required" name="perihal" value=""><?php echo set_value('perihal'); ?></textarea>
...
function validateForm() {
  ...
  $(document).ready(function() {
    ...
    $("#tgl").change(function() {
        var ini = $("#tgl").val();
        $.ajax({
          url: "<?php echo base_url()?>morsip/get_no_datir",
          type: "post",
          data: {
            in: ini
          },
    ...
    $("#nodatir").change(function() {
        var ini = $("#nodatir").val();
        $.ajax({
          url: "<?php echo base_url()?>morsip/get_add_datir",
          type: "post",
