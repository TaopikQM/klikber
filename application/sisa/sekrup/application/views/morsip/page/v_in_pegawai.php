          ...
          <div class="card-body">
            ...
            <?php $arrayName = array(
                  'class'=>"needs-validation",
                       'novalidate'=>'');
            echo form_open_multipart('morsip/save_pegawai',$arrayName);?>
            <div class="form-group">
              <div class="form-group col-md-12">
                  ...
                  <input type="text" class="form-control nip" name="nip" id="nip" required="required"  value="<?php echo set_value('nip'); ?>" data-mask="00000000 000000 0 000" placeholder="Jika Tidak Memiliki NIP silahkan isi dengan 00000000 000000 0 000">
            ...
            <div class="form-group">
              <div class="form-group col-md-12">
                  ...
                  <input type="text" class="form-control" name="nama" id="nama" required="required" value="<?php echo set_value('nama'); ?>" placeholder="Silahkan Isi Nama Dengan Huruf Kapital">
             ...
             <div class="form-row">
                ...
                <select name="jabatan" class="form-control select2 " required="required">
                  ...
                  <?php 
                    foreach ($jabatan as $ky) {?>
                        <option <?php if ($ky->id ==  set_value('jabatan') ) { echo "selected=selected"; }?>
                ...
                <select name="golongan" class="form-control select2" required="required">
                  ...
                  <?php 
                    foreach ($golongan as $ky) {?>
                        <option <?php if ($ky->id ==  set_value('golongan') ) { echo "selected=selected"; }?>
              ...
              <div class="form-group col-md-3">
                ...
                <select name="hk" class="form-control select2" required="required">
                      ...
                      <option <?php if (1 ==  set_value('hk') ) { echo "selected=selected"; }?> value="1" >Kepala Bidang</option>
                      <option <?php if (2 ==  set_value('hk') ) { echo "selected=selected"; }?> value="2" >Kepala Seksi</option>
                      <option <?php if (3 ==  set_value('hk') ) { echo "selected=selected"; }?> value="3" >PNS</option>
                      <option <?php if (4 ==  set_value('hk') ) { echo "selected=selected"; }?> value="4" >PHL</option>
                      <option <?php if (5 ==  set_value('hk') ) { echo "selected=selected"; }?> value="5" >Pengemudi / Lainnya</option>
                </select>
