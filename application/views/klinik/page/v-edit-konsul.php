          ...
          <div class="card-body">
            ...
            $arrayName = array(
                  'class'=>"needs-validation",
                       'novalidate'=>'');
            echo form_open_multipart('pasien/updateKon',$arrayName);?>
            
              <div class="form-group ">
                  <label for="nama_dokter">Nama Dokter</label>
                  <input type="hidden" name="id_dokter_old" value="<?php echo $dokter;?>">
                  <input type="text" class="form-control" name="dokter" id="dokter" value="<?php echo $dokter;?>-[<?php echo $poli;?>]" readonly>
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" name="subject"><?php echo $subject; ?></textarea>
                <?php echo form_error('subject'); ?>
                <div class="invalid-feedback">
                          Silahkan Input subject
                </div>
              </div>
              <div class="form-group">
                <label for="pertanyaan">Pertanyaan</label>
                <textarea class="form-control" name="pertanyaan"><?php echo $pertanyaan; ?></textarea>
