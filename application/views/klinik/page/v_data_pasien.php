                  ...
                  <?php if (isset($pasiens) && !empty($pasiens)): ?>
                    <?php $nomori=1; foreach ($pasiens as $key) { ?>
                        <tr bgcolor="#cccccc">
                            ...
                            <td class="text-center"><?php echo $key->alamat;?></td>
                            ...
                            <td class="text-center" >
                              ...
                              <a href="<?php $dxc=$this->encryption->encrypt(base64_encode($key->id)); $ff=str_replace(array('+','/','='),array('-','_','~'),$dxc); echo base_url();?>pasien/edit/<?php echo $ff; ?>">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer bg-whitesmoke br">
         <?php echo form_open_multipart('klinik/Pasien/delete');?>
