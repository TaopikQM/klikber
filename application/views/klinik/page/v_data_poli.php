              ...
              <table class="table table-striped table-hover" id="table-1" style="width:100%;" >
                ...
                <tbody>
                  <?php
                    ...
                    echo "</pre>";*/
                  ?>
                  <?php if (isset($polis) && !empty($polis)): ?>
                    <?php $nomori=1; foreach ($polis as $key) { ?>
                        <tr bgcolor="#cccccc">
                            <td  class="text-center"><?php echo $nomori;?></td>
                            
                            <td class="text-center" >
                              <?php 
                                echo $key->nama_poli."<br>";
                              ?>    
                            </td> 
                            ...
                            <td class="text-center" >
                              ...
                              <a href="<?php $dxc=$this->encryption->encrypt(base64_encode($key->id)); $ff=str_replace(array('+','/','='),array('-','_','~'),$dxc); echo base_url();?>poli/edit/<?php echo $ff; ?>">
                              ...
                              <button type="button" class="btn btn-danger btn-sm" data-toggle="tooltip" title="Hapus " id="hapus"  data-id="<?php echo $key->id;?>" data-nama_poli="<?php echo $key->nama_poli; ?>">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer bg-whitesmoke br">
         <?php echo form_open_multipart('klinik/Poli/delete');?>
